...
<head>
    ...
    <style>
        ...
        body{
            margin: 0;
            padding: 0;
            background: url("../../resources/login/img/pllog.jpg") no-repeat left top;
        ...
        .body{
            ...
            width: auto;
            height: auto;
            background-image: url("../../resources/login/img/pllog.jpg");
            background-size: cover;
            margin: auto;
            padding: 0;
...
<div class="header">
    ...
    <div>Avia<span>SalesUA</span></div>
</div>
<br>
<div class="login">
    <form action="${loginUrl}" method="POST">
        <input type="text" placeholder="login" name="j_login"><br>
        <input type="password" placeholder="password" name="j_password"><br>
        <input type="submit" value="Login">
        <p><a href="/register"><input type="button" value="Register"></a></p>
